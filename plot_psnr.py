...
# 2. プロット対象のファイル名
TARGET_FILENAME = "post_process_psnr.json"
...
COMPARISON_CONFIGS = [
    # 元のplot_psnr.pyの設定 (exp=5.0, gam=0.7) を反映
...
def plot_psnr(main_data, baseline_data):
    ...
    for rate in sorted_rates:
        ...
        # ファイル名生成
        save_name = f'psnr_comparison_{DATASET}_rate_{rate}.png'
